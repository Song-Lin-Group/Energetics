...
# The original script iterates over all atoms in the molecule, not just the ones attacshed to atom2 (line 435)
   ...
   for i in range(0,natom):
      ...
      for iat in range(0,natom):
         if iat != i:
            ...
            if damp > 0.7: #check if threshold is good enough for general purpose
...
# subtract one since the array starts from zero not one
      ...
      if verbose == True:
          ...
          #structures don't look nice like this anymore in python 3
